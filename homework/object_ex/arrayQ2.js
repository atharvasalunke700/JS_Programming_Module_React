...
console.log(students.push("suresh"))
console.log(students.unshift("meena"))
console.log(students)
// Q2: Remove the first and last student.
console.log(students.shift('meena'))
console.log(students.pop('suresh'))
console.log(students)
...
let stud=["anita","vivek"]
console.log(students.concat(stud))
